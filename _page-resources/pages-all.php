  ...
  var demo = function() {
    ...
    var datatable = $('.m_datatable').mDatatable({
      ...
      data: {
        ...
        source: {
          read: {
            url: 'assets/json/dummy-pages-data.php',
          },
        },
      ...
      columns: [
        {
          ...
          template: function(data) {
              return '<div class="m-card-user m-card-user--sm">\
                            <div class="m-card-user__details">\
                                ...
                                <span class="m-card-user__email">http://www.yaba.com/' + data.URL + '</span>\
                            </div>\
                        </div>';
          }
        }, {
          ...
          template: function(data) {
              return '<div class="m-card-user m-card-user--sm">\
                            <div class="m-card-user__details">\
                                <span class="m-card-user__name">' + data.Template + '</span>\
                                <span class="m-card-user__email">Parent: ' + data.Parent + '</span>\
                            </div>\
                        </div>';
          }
        }, {
