  ...
  var demo = function() {
    ...
    var datatable = $('.m_datatable').mDatatable({
      ...
      data: {
        ...
        source: {
          read: {
            url: 'assets/json/dummy-offers-data.php',
          },
        },
    ...
    function detailRow(e) {
        ...
        var cellContent = '<table class="ei-datatable-subtable">\
            <tr class="m-datatable__row">\
                <td class="m-datatable__cell">Offer type:</td>\
                <td data-field="Offer_type" class="m-datatable__cell"><span style="width: 550px;">' + e.data.Offer_type + '</span></td>\
            </tr>\
            <tr class="m-datatable__row">\
                <td class="m-datatable__cell">Offer:</td>\
                <td data-field="Offer_value" class="m-datatable__cell"><span style="width: 550px;">' + e.data.Offer_value + '</span></td>\
            </tr>\
            <tr class="m-datatable__row">\
                <td class="m-datatable__cell">Offer Products:</td>\
                <td data-field="Category" class="m-datatable__cell"><span style="width: 550px;">' + e.data.Category + '</span></td>\
            </tr>\
        </table>';
