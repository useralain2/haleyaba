                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="m-form__section m-form__section--first"> 
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control m-input" placeholder="Shipping fees">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="number" class="form-control m-input" placeholder="Min weight">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="number" class="form-control m-input" placeholder="Max weight">
                                </div>
                            </div> 
                        </div> 
                    </div> 
